    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-gray-600 mb-4">
          Get immediate assistance with your questions. Our AI assistant is here to help.
        </p>
        {!user && (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <p className="text-blue-800 mb-2">
              Create an account to save your chat history and get personalized assistance.
            </p>
      ...
      {!user && messages.length > 0 && (
        <div className="mt-6 text-center text-gray-600">
          <p className="mb-2">
            Note: Your chat history will be lost when you leave or refresh the page.
          </p>
          <Link
            to="/register"
